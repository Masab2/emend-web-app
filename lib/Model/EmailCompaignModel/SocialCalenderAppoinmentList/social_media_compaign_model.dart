...
class SocialMediaCompaignModel {
  static List<Appointment> getDataSource() {
    final List<Appointment> meetings = <Appointment>[];
    final DateTime today = DateTime.now();

    // First post on the same day
    final DateTime firstPostStartTime = DateTime(today.year, today.month, today.day, 9, 0);
    final DateTime firstPostEndTime = firstPostStartTime.add(const Duration(hours: 2));
    ...
    final DateTime secondPostStartTime = DateTime(today.year, today.month, today.day, 13, 0);
    final DateTime secondPostEndTime = secondPostStartTime.add(const Duration(hours: 1));
    meetings.add(Appointment(
    ...
    final DateTime thirdPostStartTime = DateTime(today.year, today.month, today.day, 10, 0);
    final DateTime thirdPostEndTime = thirdPostStartTime.add(const Duration(hours: 1));
    meetings.add(Appointment(
